...
convo = model.start_chat(
        history=[
                ...
                },
            {
                "role"  : "model",
                "parts" : [
                    "Olá, meu nome é Imparcibot e sou um assistente virtual imparcial. Estou aqui para ajudá-lo com suas "
                    "perguntas e solicitações de informações. Esforço-me por fornecer respostas precisas, equilibradas e "
                    "objetivas, independentemente do meu próprio preconceito ou preferência pessoal."]
                },
            ]
        )
